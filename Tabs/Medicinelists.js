...
const MedicineLists = ({ navigation }) => {
  ...
  const medicinesByCategory = {
    ...
    'Prescription Drugs': ['Alendra®', 'Algesia®', 'Allerzet® Tablet', 'Amena™', 'Amiabel®', 'Amikacide®', 'Amlife®', 'AmoClav® Suspension', 'AmoClav® Tablet', 'Ampicin® Capsule', 'Ampimax® Tablet', 'Amvasc® BE', 'Amvasc® Plus', 'Anazole®', 'Andros®', 'Appebon® with Iron Capsule', 'Appebon® with Iron Syrup', 'Asmalin® Broncho', 'Asmalin® Inhaler', 'Asmalin® Solution for Nebulization', 'Asmalin® Syrup', 'Asmavent® Nebulizing Solution', 'Aspilets®', 'Aspilets®-EC', 'Atepros®', 'Axera®', 'Bactifree®', 'Bicapros®', 'Bifix™', 'Biovinate®', 'BPNorm®', 'Candez®', 'Candez® Plus', 'Cardepine®', 'Cardiosel®', 'Cardiosel® OD', 'Carvid®', 'Cefalin® Capsule', 'Cefalin® Powder for Suspension', 'Celabin™', 'Cholinerv®', 'Citagem®', 'Clonipress®', 'Combiflex® Lipid Central', 'Combiflex® Lipid Peri', 'Combizar®', 'Comprilex®', 'Coxid®', 'Dazomet®', 'Decilone® and Decilone® Forte', 'Decolsin®', 'Dioxel®', 'Docetax®', 'Dolfenal® 500mg', 'Dopezil®', 'Doxin®', 'Doxofix™', 'Drenex®', 'Duavent® Inhaler', 'Eczacort®', 'Esensamin™', 'Exflem® Granules', 'Exflem® Tablet', 'Exigo®',
      'Exulten®',
      'Fenoflex®',
      'Floxel®',
      'Flutizal®',
      ...
      'Hyos® Solution',
      'Hytaz®',
      'Inoflox® Ophthalmic Solution',
      'Inoflox® Otic Drops',
      'Inoflox® Tablet and Solution',
      'Isoxilan®',
      'Jovia®',
      'Kastair®',
      'Kastair® EZTab®',
      'Klaz® and Klaz® OD',
      'Klindex® Capsule',
      'Klindex® Solution for Injection',
      'Kortezor®',
      'Lavida®',
      'Levox®',
      'Lifezar®',
      ...
      'Movelax®',
      'Mupicin®',
      'Naprex® Solution for Injection',
      'Nasoflo®',
      'Neo-Pyrazon®',
      'Neocyte®',
      'Nirva®',
      'Norizec®',
      'Omepron® 40 mg Capsule',
      'Omepron® Vial',
      'OraVacs',
      'Osteomet®',
      'Oxalee®',
      ...
      'Vascoride®',
      'Vascor®',
      'Versant®-XR 10 mg Tablet',
      'Versant®-XR 5mg Tablet',
      'Vestar®',
      'Victus®',
      'Vidastat®',
      'Xelent®',
